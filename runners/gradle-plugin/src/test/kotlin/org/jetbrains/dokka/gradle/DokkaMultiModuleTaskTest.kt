...
class DokkaMultiModuleTaskTest {
    ...
    fun buildDokkaConfiguration() {
        ...
        multiModuleTask.apply {
            ...
            pluginsConfiguration.add(PluginConfigurationImpl("pluginA", DokkaConfiguration.SerializedType.JSON, """ { "key" : "value2" } """))
        ...
        assertEquals(
            DokkaConfigurationImpl(
                ...
                pluginsConfiguration = mutableListOf(PluginConfigurationImpl("pluginA", DokkaConfiguration.SerializedType.JSON, """ { "key" : "value2" } """)),
