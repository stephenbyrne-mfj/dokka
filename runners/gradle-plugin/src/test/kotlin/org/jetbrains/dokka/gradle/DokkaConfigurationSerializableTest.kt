...
class DokkaConfigurationSerializableTest {
    ...
    fun `DokkaTask configuration write to file then parse`() {
        ...
        dokkaTask.apply {
            ...
            this.pluginsConfiguration.add(PluginConfigurationImpl("A", DokkaConfiguration.SerializedType.JSON, """ { "key" : "value1" } """))
            this.pluginsConfiguration.add(PluginConfigurationImpl("B", DokkaConfiguration.SerializedType.JSON, """ { "key" : "value2" } """))
